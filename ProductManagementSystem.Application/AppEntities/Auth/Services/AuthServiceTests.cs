...
public class AuthServiceTests
{
    ...
    private UserPlan CreateValidUserPlan(int maxDevices = 5)
    {
        ...
        var subscription = Subscription.Create(
            ...
            price,
            ProductManagementSystem.Application.AppEntities.Subscriptions.Enums.EnumSubscriptionPeriod.Monthly,
            restrictions
        );
    ...
    private UserDTO CreateValidUserDTO()
    {
        return new UserDTO
        {
            ...
            Name = "Test User",
            Email = "test@example.com",
            Teams = new List<ProductManagementSystem.Application.AppEntities.Users.DTOs.Outputs.CompanyInfoDTO>
            {
                new ProductManagementSystem.Application.AppEntities.Users.DTOs.Outputs.CompanyInfoDTO
                {
                    Name = "Test Company",
