...
public class ProductControllerTests
{
    ...
    public async Task GetAll_WithValidFilter_ShouldReturnOkResult()
    {
        ...
        _mockProductService.Setup(s => s.GetAllAsync(paginationConfigs, filter, null))
        ...
        _mockProductService.Verify(s => s.GetAllAsync(paginationConfigs, filter, null), Times.Once);
    }
